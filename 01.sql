...
Select SerialNumber, Type, Version, Color from STOVE;
GO
...
Select PartNbr,Description from PART order by SalesPrice asc;
GO
...
Select SalesPrice, Description from PART WHERE PartNbr = '569';
GO
